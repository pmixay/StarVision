...
export function SatelliteInfoPanel({ satellites, positions }: SatelliteInfoPanelProps) {
  const {
    ...
    orbitAltitudeKm, orbitalPlanes, orbitInclinationDeg, satelliteCount, timeSpeed,
    tleData, tleMeta,
  } = useStore();
  ...
  useEffect(() => {
    ...
    const interval = setInterval(() => {
      ...
      const { x, y, z } = computeVirtualECI(idx, satelliteCount, orbitAltitudeKm, simTimeSec, orbitalPlanes, inclRad);
  ...
  }, [isVirtual, selectedSatellite, orbitAltitudeKm, orbitalPlanes, orbitInclinationDeg, satelliteCount, timeSpeed]);
