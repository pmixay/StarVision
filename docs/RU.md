...
- **15 российских КА** в каталоге (все активные; жёсткий лимит, совпадает с максимумом ползунка): Декарт, НОРБИ, Ярило-1, CubeSX-HSE, УмКА-1, НОРБИ-2, CubeSX-HSE-3, Монитор-2, Ярило-3, СамСат-Ионосфера, TUSUR GO, RTU MIREA-1, Горизонт, ASRTU-1, Vizard-ion
