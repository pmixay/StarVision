...
|---|---|---|
| 3–15 satellites in 3D | Slider 3..15 clamps at store level (uniform sub-sampling from 17-sat catalog) | [ControlPanel.tsx](frontend/src/components/ControlPanel.tsx), [useStore.ts](frontend/src/hooks/useStore.ts), [clamps.ts](frontend/src/lib/clamps.ts) |
...
- Real-time 3D visualization of 3–15 satellites in orbit (selected from a 17-spacecraft catalog)
...
- 3D-визуализация 3–15 спутников на орбите в реальном времени (выборка из каталога 17 КА)
...
| **SPUTNIX** | CubeSX-HSE (47952), CubeSX-HSE-3 (57178), VIZARD-meteo (57189) | Earth observation, Arctic monitoring / ДЗЗ, мониторинг Арктики | 3U |
...
| **Space-Pi** | ReshUCube-2 (57168), TUSUR GO (61782), RTU MIREA-1 (61785), Horizont (61757), ASRTU-1 (61781) | Educational, scientific / Образовательные, научные | 3U |
...
│   ├── satellites.py         # 17 Russian CubeSats catalog + TLE / Каталог КА
...
| GET | `/api/satellites` | List of all 17 spacecraft / Список всех 17 КА |
